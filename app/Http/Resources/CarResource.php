        ...
        return [
            ...
            'tabs'=>[
                ...
                'policies'=>[
                    ...
                    'Chủ Xe'=>['<div class="text-green-600">Hoàn cọc 100%</div><div class="text-gray-600 text-xs dark:text-slate-100">(Bị đánh giá 3 sao)</div>','<div class="text-amber-600">Hoàn cọc 100%<br/> (+50% giá trị cọc)</div><div class="text-gray-600 text-xs dark:text-slate-100">(Bị đánh giá 2 sao)</div>','<div class="text-red-600">Hoàn cọc 100% <br/>(+100% giá trị cọc)</div><div class="text-gray-600 text-xs dark:text-slate-100">(Bị đánh giá 1 sao)</div>']
                ],
